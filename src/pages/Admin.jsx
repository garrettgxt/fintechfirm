  ...
  return (
    <div style={{ padding: 40, maxWidth: 900, margin: "0 auto" }}>
      ...
      <div style={{ fontSize: 13, color: "rgba(237,231,218,0.5)", marginBottom: 24 }}>
        Toggling Demo Mode shows the account a fake balance you set, clearly
        labeled as demo — it never touches their real on-chain funds.
      </div>
    ...
    <div style={{ background: "var(--ink-2)", border: "1px solid var(--line)", borderRadius: 6, padding: 20, marginBottom: 12 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 12 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          />
          <button className="btn-secondary" onClick={() => onUpdate(wallet.wallet_address, demoMode, demoBalance)}>
            Save
          </button>
        </div>
      </div>
